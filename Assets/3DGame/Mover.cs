...
class Mover : MonoBehaviour
{
    ...
    Vector3 GetInputDirction()
    {
        ...
        // Vector3 direction = new Vector3(x, 0, z); nem kamerához képest
        // Vector3 rightd = Vector3.right; ez globális
        Vector3 rightd = cameraTransform.right; // ez lokális
                                                // Vector3 forwardd = Vector3.forward;      //cinemashin megír camerabeállítás
